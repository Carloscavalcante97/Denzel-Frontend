...
export default function Clientes() {
  ...
  const EVENT_URL = "https://denzelbackend-f5faejb8a3akg9fu.brazilsouth-01.azurewebsites.net/api/eventos/Listar-Evento";
...
const [dropdownLocked, setDropdownLocked] = useState(false);
  ...
  async function fetchTodosClientes() {
    if (!token) return;
    try {
      const response = await fetch(`https://denzelbackend-f5faejb8a3akg9fu.brazilsouth-01.azurewebsites.net/api/clientes/ListarTodos`, {
        headers: {
