...
export default function Eventos() {
  ...
  const [eventoParaExcluir, setEventoParaExcluir] = useState<{ id: number; nome: string } | null>(null);
    ...
    <div className="min-h-screen flex flex-col bg-[#100D1E] text-white">
      ...
      {eventoParaExcluir && (
        <ModalExcluirEvento
          ...
          idEvento={eventoParaExcluir.id}
          nomeEvento={eventoParaExcluir.nome}
