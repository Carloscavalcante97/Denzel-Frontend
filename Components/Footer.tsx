...
export default function Footer() {
  return (
    <div className="w-full bg-gradient-to-l from-[#43A3D5] to-[#9C60DA] p-4 text-white">
      <div className="container mx-auto flex flex-col md:flex-row items-center justify-between px-4 text-sm text-center md:text-left gap-4 md:gap-10 text-base font-lexend text-white-700">
